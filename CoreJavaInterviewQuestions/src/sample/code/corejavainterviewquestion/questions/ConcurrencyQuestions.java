...
public class ConcurrencyQuestions extends Activity implements OnClickListener {

	private static final String ANSWER = "answer";
	private static final String INDEX = "index";
	private String[] concurrencyQuestions = null;
	private String[] concurrencyAnswers = null;
	private int index;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		concurrencyQuestions = getResources().getStringArray(
				R.array.concurrency_questions);
		concurrencyAnswers = getResources().getStringArray(
				R.array.concurrency_answers);
		...
		textviewQuestion.setText(concurrencyQuestions[index]);
		textviewAnswer.setText(defaultTextviewAnswer);
		textviewXX.setText(String.valueOf(index + 1) + "/");
		textviewYY.setText(String.valueOf(concurrencyQuestions.length));
		
		textviewSubject.setText("Java - Concurrency API");
	...
	public void onClick(final View v) {
		index = Utils.getInstance().onClickEvent(v, index, textviewAnswer, textviewQuestion,
				textviewXX, concurrencyQuestions, concurrencyAnswers,
